//Draws GCS Fields and calculates GCS Total 
"use client"
...
export default function GcsScores({ gcs_total, setGcsTotal }) {
    ...
    {/* updates Eye selection and passes that value to calculateTotalScore  */}
    ...
    {/* updates Verbal selection and passes that value to calculateTotalScore  */}
    ...
    {/* updates Motor  selection and passes that value to calculateTotalScore  */}
    ...
    const calculateTotalScore = (eye, verbal, motor) => {
        //cast props to ints for proper addition 
